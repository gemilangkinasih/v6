...
echo -e "         OWNER : ${GREEN} @Gemilang-Kinasih ${NC}${YELLOW}(${NC} ${GREEN} BIGETRO RED ALIEND  ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By @GemilangKinasih ${YELLOW}(${NC} 2023-2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
